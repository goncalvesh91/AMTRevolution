...
namespace AppCore.AppSettings
{
    ...
    public static class AppSettings
    {
        ...
        public static string appEventsPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + @"\AMTRevolution\AppEventLog.xbin";
        ...
        // User logs in network
        public const string userLogsNetworkPath = @"\\vf-pt\fs\ANOC-UK\ANOC-UK 1st LINE\1. RAN 1st LINE\AMTRevolution\usercontent";

        // User logs in %AppData%
        public static string userLogsPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + @"\AMTRevolution\";
